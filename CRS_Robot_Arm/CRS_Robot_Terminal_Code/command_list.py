...
command_list ={
                ...
                # A = Application Command, C = Uses Webcam, N = No Robot Needed T = Has time function
    "(CAPIMG)": {
        "comment": "(/300)",
    ...
    "(RECVID)": {
        "comment": "(/301)",
        "description": "Begin Recording Video, use variable 1-60 to set recording time in seconds",
        "format": "(REDVID)25 ",
        "modes": "A, C, N, T",
        "app": "record_video$",
    },
    ...
    "(CAMCONN)": {
        "comment": "(/305)",
        "description": "Connect Webcam on last known, or selected port",
        "format": " ",
        "modes": "A, C",
        "app": "self. ",
    },
    ...
    "(CAMWAIT)": {
        "comment": "(/307)",
        "description": "Pause and Resume webcam feed. (CAMWAIT)end to resume feed. (SEETEXT) command should resume aswell ",
        "format": "(CAMWAIT), (CAMWAIT)end",
        "modes": "A, C",
        "app": "self. ",
    },    
